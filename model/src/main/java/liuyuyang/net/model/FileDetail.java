...
public class FileDetail {
    ...
    private Long size; // 文件大小，单位字�?
    private String filename; // 文件名称

    private String originalFilename; // 原始文件�?
    ...
    private String thUrl; // 缩略图访问路�?
    private String thFilename; // 缩略图名�?
    ...
    private String objectType; // 文件所属对象类型，例如用户头像，评价图�?
    private String metadata; // 文件元数�?
    private String userMetadata; // 文件用户元数�?
    private String thMetadata; // 缩略图元数据

    private String thUserMetadata; // 缩略图用户元数据

    private String attr; // 附加属�?
    ...
    private Integer uploadStatus; // 上传状态，仅在手动分片上传时使用，1：初始化完成�?：上传完�?
